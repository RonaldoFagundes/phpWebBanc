...
session_start(); 
 ...
 $comp = filter_input(INPUT_GET,'comp');
...
<header class="header">
 ...
 <div class="sidenav">    	
  <form method="post" action="controll.php" >
   ...
   <button type="submit" class="btn-mov" name="btn_voltar">Voltar</button> 
  </form>  	
 </div>
</header>
<div class="space"></div>
 <section class="main-comp">  
  <div class="mov-intru-info">
   <input  readonly class="mii-id"   value="<?php echo $id; ?>"   >
   <input  readonly class="mii-user" value="<?php echo $user;?>"  >
   <input  readonly class="mii-cnt"  value="<?php echo $conta;?>" >
  </div>	
